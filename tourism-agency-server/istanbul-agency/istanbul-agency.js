...
// Dinamik gecikme süresi hesaplama
const distance_km = 10; // Ajansın uzaklığı
const delay = (distance_km / 10) * 1000; // Milisaniye cinsinden gecikme

// Asenkron bir endpoint
